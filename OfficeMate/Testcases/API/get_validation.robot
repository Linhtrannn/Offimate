...
Library     DataDriver                              ../../TestData/data_api.xlsx    sheet_name=Get
...
*** Test Cases ***
Jsonplaceholder Get Request Test    ${is_flash_deal}          ${flash_deal_enable}    ${sort}                 ${type_id}         ${typeid}        ${flash_deal_from}
